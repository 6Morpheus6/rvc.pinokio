  ...
  run: [
    ...
    // windows amd
    {
      ...
      "params": {
        ...
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": [
          "uv pip install torch-directml torch==2.4.1 torchvision==0.19.1 torchaudio==2.4.1 numpy==1.26.4",
    ...
    // windows cpu
    {
      ...
      "params": {
        ...
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": [
          "uv pip install torch==2.3.0 torchvision==0.18.0 torchaudio==2.3.0 numpy==1.26.4",
    ...
    // intel mac
    {
      ...
      "params": {
        ...
        "path": "{{args && args.path ? args.path : '.'}}",
        "message": [
          "uv pip install torch==2.2.2 torchvision==0.17.2 torchaudio==2.2.2 --index-url https://download.pytorch.org/whl/cpu",
          "uv pip install onnxruntime"
        ]
      }
    },
